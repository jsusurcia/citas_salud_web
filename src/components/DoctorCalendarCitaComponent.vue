<template>
    <div class="calendario-container">
        <vue-cal :time-from="7 * 60" :time-to="22 * 60" :time-step="30" active-view="week"
            :disable-views="['years', 'month']" :events="eventosDelCalendario" :editable-events="false"
            :on-event-click="manejarClickEnEvento" style="height: 600px;" :locale="'es'">
        </vue-cal>
    </div>
</template>
...
.vuecal__event.cita-en_atencion {
